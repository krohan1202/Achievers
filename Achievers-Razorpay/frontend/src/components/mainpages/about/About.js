...
export default function About() {
    return (
        ...
        <div className="ach__about">
            ...
            <p className="ach__about--whyAch--p">1. Practice commission review test papers</p>
            <p className="ach__about--whyAch--p">2. Online Mock assessments for different Competitive Exams</p>
